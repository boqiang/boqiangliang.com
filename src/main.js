...
const roomImages = {
  day: "url('/images/white-sea-study-open-window.png?v=0.0.22')",
  dawn: "url('/images/white-sea-study-dawn.png?v=0.0.22')",
  sunset: "url('/images/white-sea-study-sunset.png?v=0.0.22')",
  overcast: "url('/images/white-sea-study-overcast.png?v=0.0.22')",
  fog: "url('/images/white-sea-study-fog.png?v=0.0.22')",
  rain: "url('/images/white-sea-study-rain.png?v=0.0.22')",
  storm: "url('/images/white-sea-study-storm.png?v=0.0.22')",
  night: "url('/images/white-sea-study-night-open-window.png?v=0.0.22')",
  moonFog: "url('/images/white-sea-study-moon-fog.png?v=0.0.22')"
};
